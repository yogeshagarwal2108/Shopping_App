...
//      if(editingProduct.id== null){
//        try{
//          await Provider.of<ProviderProducts>(context, listen: false).addProduct(editingProduct);
//        }catch(error){
//          await showDialog(
//            context: context,
//            builder: (context)=> AlertDialog(
...
//      }
//      else{
//        await Provider.of<ProviderProducts>(context, listen: false).updateProduct(editingProduct, editingProduct.id);
//      }
//
//      setState(() {
//        isLoading= false;
...
//        ],
//      ),
//      body: isLoading ? Center(child: CircularProgressIndicator(backgroundColor: Theme.of(context).primaryColor,)) : Form(
//        key: _formKey,
//        child: SingleChildScrollView(
//          child: Column(
//            children: <Widget>[
...
////                        borderRadius: BorderRadius.circular(10),
//                      ),
//                      child: _imageUrlController.text.isEmpty ? Text("No image url", textAlign: TextAlign.center,) : FittedBox(
//                        child: Image.network(_imageUrlController.text),
//                        fit: BoxFit.cover,
//                      ),
//                    ),
